...
public interface DisasterRecoveryService {
    ...
    List<GetDisasterRecoveryResponse> listDisasterRecoverys(GetDisasterRecoveryCmd cmd);

    boolean runDisasterRecoveryCommand(RunDisasterRecoveryCmd runDisasterRecoveryCmd);
}
