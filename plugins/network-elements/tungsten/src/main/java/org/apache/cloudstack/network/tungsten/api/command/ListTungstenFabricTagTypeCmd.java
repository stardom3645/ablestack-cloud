...
@APICommand(name = ListTungstenFabricTagTypeCmd.APINAME, responseObject = TungstenFabricTagTypeResponse.class,
    description =
...
public class ListTungstenFabricTagTypeCmd extends BaseListCmd {
    ...
    @Parameter(name = ApiConstants.TAG_TYPE_UUID, type = CommandType.STRING, description = "the uuid of Tungsten-Fabric tag type")
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenTagTypes(zoneId, tagTypeUuid));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenTagTypes(tungstenProvider.getZoneId(), tagTypeUuid));
            }
        }
