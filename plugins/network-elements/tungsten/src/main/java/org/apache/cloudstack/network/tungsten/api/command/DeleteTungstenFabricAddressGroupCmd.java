...
public class DeleteTungstenFabricAddressGroupCmd extends BaseAsyncCmd {
    protected static Logger s_logger = LogManager.getLogger(DeleteTungstenFabricAddressGroupCmd.class.getName());
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        boolean result = tungstenService.deleteTungstenAddressGroup(zoneId, addressGroupUuid);
        if (result) {
            SuccessResponse response = new SuccessResponse(getCommandName());
            this.setResponseObject(response);
        } else {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to delete Tungsten-Fabric address group");
        }
    }

    @Override
    public String getEventType() {
        return EventTypes.EVENT_TUNGSTEN_DELETE_ADDRESS_GROUP;
    }

    @Override
    public String getEventDescription() {
        return "delete Tungsten-Fabric address group";
    }
