...
public class ListTungstenFabricServiceGroupCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenServiceGroup(zoneId, serviceGroupUuid));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenServiceGroup(tungstenProvider.getZoneId(), serviceGroupUuid));
            }
        }
