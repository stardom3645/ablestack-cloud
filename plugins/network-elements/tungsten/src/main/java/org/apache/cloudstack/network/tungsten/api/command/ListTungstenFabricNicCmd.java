...
public class ListTungstenFabricNicCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenNic(zoneId, nicUuid));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenNic(tungstenProvider.getZoneId(), nicUuid));
            }
        }
