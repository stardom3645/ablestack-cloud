...
public class ListTungstenFabricPolicyRuleCmd extends BaseListCmd {
    protected static Logger s_logger = LogManager.getLogger(ListTungstenFabricPolicyRuleCmd.class.getName());
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenPolicyRule(zoneId, policyUuid, ruleUuid));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenPolicyRule(tungstenProvider.getZoneId(), policyUuid, ruleUuid));
            }
        }
