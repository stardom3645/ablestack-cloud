...
public class ListTungstenFabricPolicyCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenPolicy(zoneId, networkId, addressId, policyUuid));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenPolicy(tungstenProvider.getZoneId(), networkId, addressId, policyUuid));
            }
        }
