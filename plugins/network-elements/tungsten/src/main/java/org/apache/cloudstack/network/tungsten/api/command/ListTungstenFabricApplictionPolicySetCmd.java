...
public class ListTungstenFabricApplictionPolicySetCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenApplicationPolicySet(zoneId, applicationPolicySetUuid));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenApplicationPolicySet(tungstenProvider.getZoneId(), applicationPolicySetUuid));
            }
        }
