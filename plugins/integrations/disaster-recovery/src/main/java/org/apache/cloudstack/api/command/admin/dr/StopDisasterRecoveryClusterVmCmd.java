...
public class StopDisasterRecoveryClusterVmCmd extends BaseCmd implements AdminCmd {
    public static final String APINAME = "stopDisasterRecoveryClusterVm";
    ...
    public void execute() throws ServerApiException {
        try {
            if (!disasterRecoveryClusterService.stopDisasterRecoveryClusterVm(this)) {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, String.format("Failed to stop disaster recovery cluster virtual machine ID: %d", getId()));
            }
