...
@APICommand(name = StartDisasterRecoveryClusterVmCmd.APINAME,
        description = "Start a disaster recovery cluster virtual machine",
        responseObject = SuccessResponse.class,
        authorized = {RoleType.Admin})
public class StartDisasterRecoveryClusterVmCmd extends BaseCmd implements AdminCmd {
    public static final String APINAME = "startDisasterRecoveryClusterVm";
    ...
    public void execute() throws ServerApiException {
        try {
            if (!disasterRecoveryClusterService.startDisasterRecoveryClusterVm(this)) {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, String.format("Failed to start disaster recovery cluster virtual machine ID: %d", getId()));
            }
