...
public final class LibvirtReadyCommandWrapper extends CommandWrapper<ReadyCommand, Answer, LibvirtComputingResource> {
    ...
    public Answer execute(final ReadyCommand command, final LibvirtComputingResource libvirtComputingResource) {
        ...
        if (hostSupportsUefi(libvirtComputingResource, libvirtComputingResource.isUbuntuHost()) && libvirtComputingResource.isUefiPropertiesFileLoaded()) {
    ...
    private boolean hostSupportsUefi(final LibvirtComputingResource libvirtComputingResource, final boolean isUbuntuHost) {
