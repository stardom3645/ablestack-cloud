...
public interface ManagementService {
    ...
    ListResponse<ListHostDevicesResponse> updateHostDevices(UpdateHostDevicesCmd cmd);

    // ListResponse<ListHostDevicesResponse> deleteHostDevices(DeleteHostDevicesCmd cmd);
