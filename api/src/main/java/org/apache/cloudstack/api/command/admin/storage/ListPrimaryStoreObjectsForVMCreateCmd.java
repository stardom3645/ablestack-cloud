...
@APICommand(name = "listPrimaryStoreObjectsForVMCreate", description = "Lists objects at specified path on a storage pool.",
            responseObject = DataStoreObjectResponse.class, since = "4.19.0", requestHasSensitiveInfo = false,
            responseHasSensitiveInfo = false)
public class ListPrimaryStoreObjectsForVMCreateCmd extends BaseListCmd {
    ...
    @Override
    public void execute() {
        ListResponse<DataStoreObjectResponse> response = storageBrowser.listPrimaryStoreObjectsForVMCreate(this);
