  ...
  methods: {
    ...
    updateData (item) {
      if (item.name === 'api.allowed.source.ip') {
        ...
        (this.editableValueSplit[2] === '1' && this.editableValueSplit[3] === '0') || (this.editableValueSplit[2] === '1' && this.editableValueSplit[3] === '255') ||
        this.editableValue === '0.0.0.0' || this.editableValue === '255.255.255.255' || this.editableValue === '127.0.0.1') {
